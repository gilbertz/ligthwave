...
/* DEFWFDB is the default value of the WFDB path if the WFDB environment
   ...
   If WFDB_NETFILES support is disabled, the string ". /home/zgq/ligthwave/wfdb-10.5.24/build/database" is
   usually sufficient for a default WFDB path, thus restricting the search for
   WFDB files to the current directory ("."), followed by /home/zgq/ligthwave/wfdb-10.5.24/build/database).
...
# define DEFWFDB	". /home/zgq/ligthwave/wfdb-10.5.24/build/database"
#else
# define DEFWFDB ". /home/zgq/ligthwave/wfdb-10.5.24/build/database http://physionet.org/physiobank/database"
#endif
